...
var dirsCmd = &cobra.Command{
	Use:   "dirs",
	Short: "Print directories used by KawaiCode",
	Long: `Print the directories where KawaiCode stores its configuration and data files.
...
var configDirCmd = &cobra.Command{
	Use:   "config",
	Short: "Print the configuration directory used by KawaiCode",
	Run: func(cmd *cobra.Command, args []string) {
		cmd.Println(filepath.Dir(config.GlobalConfig()))
	},
}
...
var dataDirCmd = &cobra.Command{
	Use:   "data",
	Short: "Print the data directory used by KawaiCode",
	Run: func(cmd *cobra.Command, args []string) {
		cmd.Println(filepath.Dir(config.GlobalConfigData()))
	},
}
