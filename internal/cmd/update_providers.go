...
kawaicode update-providers

# Update Catwalk providers from a custom URL
kawaicode update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
kawaicode update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
kawaicode update-providers embedded

# Update Hyper provider information
kawaicode update-providers --source=hyper

# Update Hyper from a custom URL
kawaicode update-providers --source=hyper https://hyper.example.com
`,
